...
: ${AMENT_CURRENT_PREFIX:="/home/seema/ros2_ws/install/pymoveit2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pymoveit2/environment/library_path.sh"
